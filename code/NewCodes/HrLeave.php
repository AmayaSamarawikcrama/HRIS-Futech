...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-12  col-lg-100 px-5">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Pending</td>
                                <td>
                                    <button class="btn btn-success btn-sm" onclick="updateStatus(this, 'Approved')">Approve</button>
                                    ...
                                    <button class="btn btn-primary btn-sm" onclick="viewDetails('John Doe', 'Sick Leave', '2025-04-10', '2025-04-12')">View Details</button>
                                    <script>
                                        function viewDetails(name, leaveType, startDate, endDate,reson) {
                                            const details = `
                                                <div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" id="modalBody">
                                                    ...
                                                    <p><strong>Reason:</strong> <!-- Reason will be dynamically added here --></p>
                                                </div>
