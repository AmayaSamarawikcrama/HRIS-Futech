...
<body>
    <div class="container-fluid">
        ...
        <div class="row mt-4 g-2">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <button class="btn btn-primary w-100 p-3 fs-6" onclick="location.href='EmpLeave.html'">Leave Request</button>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <button class="btn btn-primary w-100 p-3 fs-6" onclick="location.href='EmpManualAttendance.html'">My Attendance</button>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                <button class="btn btn-primary w-100 p-3 fs-6" onclick="location.href='EmpProject.html'">Our Projects</button>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3">
